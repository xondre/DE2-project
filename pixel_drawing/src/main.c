...
/* Defines -----------------------------------------------------------*/
#define CLK PD0   //main output from rotary encoder                   
#define DT PD1    //reference output from rotary encoder
#define SW_ENC PD2  //button output from rotary encoder
#define SW_JS PD3   //button output from joystick

#define DIGIT_H 7   //height of one digit in pixels
...
{   
    ...
    GPIO_mode_input_pullup(&DDRD, SW_ENC);
